...
import edu.rit.edgeconverter.model.Connector;
...
public class EdgeFileParser extends FileParser{
    ...
    private ArrayList<Connector> allConnectors;
    ...
    public EdgeFileParser(File fileToParse){
        numFigure = 0;
        numConnector = 0;
    ...
    public void makeArrays() {
        ...
        if (allConnectors != null) {
            connectors = (Connector[])allConnectors.toArray(new Connector[allConnectors.size()]);
        }
    }
...
//                            ConverterGUI.setReadSuccess(false);
            ...
            if (currentLine.startsWith("Connector ")) { //this is the start of a Connector entry
                ...
                allConnectors.add(new Connector(numConnector + DELIM + endPoint1 + DELIM + endPoint2 + DELIM + endStyle1 + DELIM + endStyle2));
            } // if("Connector")
        } // while()
    }
...
//                ConverterGUI.setReadSuccess(false); //this tells GUI not to populate JList components
    ...
    public void parseSaveFile() {
        // TODO: implement parse save file
    }
